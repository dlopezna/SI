...
<asp:UpdateProgress ID="updP" runat="server" AssociatedUpdatePanelID="upd_Filtro" DisplayAfter="0">
        <ProgressTemplate>
            <div id="upd_progress">
    ...
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="upd_Centro" DisplayAfter="0">
        <ProgressTemplate>
            <div id="upd_progress">
                <div style="margin-top: 25%;">
                    <img src="../Images/loading.gif" alt="cargando..." style="vertical-align: middle;
        ...
        <center>
            <table>
                <tr>
                    ...
                    <td>
                        <span>
                            <asp:TextBox ID="txtFinicio" runat="server" CssClass="txtInput" Style="vertical-align: middle; z-index:100;" /></span>
                    </td>
                    <td>
                        <asp:Image runat="server" ID="imgcal1" AlternateText="Calendario" ImageUrl="~/Images/calendar1.png" BorderWidth="1px" BorderStyle="Ridge"
                    ...
                    <td>
                        ...
                        <asp:Image runat="server" ID="imgcal2" AlternateText="Calendario" ImageUrl="~/Images/calendar1.png" BorderWidth="1px" BorderStyle="Ridge"
                            Style="vertical-align: middle;" />
                    </td>
                    <td>
                        <asp:UpdatePanel ID="upd_Filtro" runat="server">
                            <ContentTemplate>
                                <asp:ImageButton runat="server" ID="cmdFiltrar" AlternateText="Filtrar" ImageUrl="~/Images/filter-20.png" BorderWidth="1px" BorderStyle="Ridge"
                                    OnClick="Filtrar" Style="vertical-align: middle;" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>
    ...
    <div id="centro">
     <asp:UpdatePanel ID="upd_Centro" runat="server">
    <ContentTemplate>
    ...
    <cc1:CalendarExtender ID="txtFinicio_CalendarExtender" runat="server" Enabled="True"
        TargetControlID="txtFinicio" Format="dd/MM/yyyy" PopupButtonID="imgCal1">
    </cc1:CalendarExtender>
    <cc1:CalendarExtender ID="txtFfinal_CalendarExtender" runat="server" Enabled="True"
        TargetControlID="txtFfinal" Format="dd/MM/yyyy" PopupButtonID="imgCal2">
    </cc1:CalendarExtender>
