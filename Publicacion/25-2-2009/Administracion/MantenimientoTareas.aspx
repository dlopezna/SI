...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="upd_lvTareas"
        DisplayAfter="0">
        <ProgressTemplate>
            <div id="upd_progress">
    ...
    <div id="centro">
        <asp:UpdatePanel ID="upd_lvTareas" runat="server">
            <ContentTemplate>
                                                ...
                                                <td id="Td1" runat="server">
                                                    <table id="itemPlaceholderContainer" runat="server" border="0" width="100%" cellpadding="0"
                                                        ...
                                                        <tr id="Tr2" runat="server" class="listview-head">
                                                            ...
                                                            <th id="Th3" runat="server" style="width: 5%">
                                                            </th>
                                                            <th id="Th2" runat="server" style="width: 90%">
                                                            </th>
                                                        </tr>
                                                        <tr id="itemPlaceholder" runat="server">
                                                        </tr>
