...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
  <div id="titular">
    ...
    <iframe id="ifsunnyPortal" frameborder="0" runat="server" scrolling="yes" width="100%" height="450px" src="http://www.sunnyportal.com/PublicPage.aspx?page=ced58d3b-ec55-48f7-afc1-231b888d6eb1">
    </iframe>
    </div>
