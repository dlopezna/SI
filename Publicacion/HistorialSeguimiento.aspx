        ...
        <center>
            <table>
                <tr>
                    ...
                    <td>
                        <span>
                            <asp:TextBox ID="txtFinicio" runat="server" CssClass="txtInput" Style="vertical-align: middle;" /></span>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:UpdatePanel ID="upd_Filtro" runat="server">
                            <ContentTemplate>
                                <asp:ImageButton runat="server" ID="cmdFiltrar" AlternateText="Filtrar" ImageUrl="~/Images/filter.png"
