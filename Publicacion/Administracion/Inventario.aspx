    ...
    <asp:UpdatePanel ID="upd_divMenu" runat="server">
        <ContentTemplate>
            <div id="menu">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:ImageButton ID="cmdSeguimiento" runat="server" AlternateText="Ver segumiento"
                    BorderStyle="Ridge" BorderWidth="1px" ImageUrl="~/Images/Contenidos.png" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
    <div id="inventario">
                        ...
                        <ContentTemplate>
                            <div id="divAltaInventario" class="altaInventario">
                                ...
                                <asp:DropDownList ID="cbPlantas" runat="server" DataSourceID="dsPlantas" DataTextField="NSerie"
                                    DataValueField="NSerie" /><br />
                                    <asp:Label ID="lblEnlaceSunny" runat="server" CssClass="txtLabel" Text="Enlace Sunny:" /><asp:TextBox ID="txtEnlaceSunny" runat="server" Width="600px" CssClass="txtInput" />
                            </div>
                            <div>
