...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
 <asp:UpdateProgress ID="updP" runat="server" AssociatedUpdatePanelID="upd_lvIncidencias">
        <ProgressTemplate>
            <div id="trans" style="background:silver; width: 1024px; height: 768px; z-index: 100;margin-top:0;margin-left:0;filter:alpha(opacity=60);">
                    ...
                    <ItemTemplate>
                        <tr class="elemento">
                            <td>
                                ...
                                <%--<asp:LinkButton ID="lblID" CommandName="Select" runat="server" Text='<%# Eval("ID") %>' />--%>
                            </td>
                            <td>
                                ...
                                <td id="Td1" runat="server">
                                    <table id="itemPlaceholderContainer" runat="server" border="0" width="100%" cellpadding="0"
                                        ...
                                        <tr id="Tr2" runat="server" class="listview-head">
                                            <th id="Th2" runat="server" style="width: 7%">
                                            </th>
                                            <th id="Th3" runat="server" style="width: 43%">
                                                Definición
                                            </th>
