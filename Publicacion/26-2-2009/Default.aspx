...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <div id="dcha">
        ...
        <asp:SqlDataSource ID="dsPlantas" runat="server" ConnectionString="<%$ ConnectionStrings:IGMIncidenciasConnectionString %>"
            SelectCommand="SELECT Plantas.Nserie, Inversores.Nserie AS Inversor, Plantas.Descripcion, Inversores.EnlaceSUNNY FROM Plantas LEFT OUTER JOIN Inversores ON Plantas.Nserie = Inversores.ID_PLANTA">
        </asp:SqlDataSource>
    </div>
    <div id="izda">
        <div class="subtitular">
        ...
        <div>
            <span class="explicacion" style="font-size:medium;"><a  href="changepassword.aspx">Cambiar Clave</a></span>
        </div>
