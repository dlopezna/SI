            ...
            <ContentTemplate>
                <asp:ListView ID="lvOrdenesA" runat="server" DataSourceID="dsOrdenes" OnSelectedIndexChanged="CargarOrden">
                    ...
                    <SelectedItemTemplate>
                        <tr class="seleccion">
                            <td>
                                <img alt="ver" src="Images/Find.png" onclick="openfrmOrden()" style="vertical-align:middle; border-width:1px ; border-style:Ridge;" />
            ...
            <ContentTemplate>
                <asp:ListView ID="lvOrdenesC" runat="server" DataSourceID="dsOrdenesCerradas" OnSelectedIndexChanged="CargarOrden">
                    ...
                    <SelectedItemTemplate>
                        <tr class="seleccion">
                            <td>
                                <img alt="ver" src="Images/Find.png" onclick="openfrmOrden()" style="vertical-align:middle; BorderWidth:1px ; BorderStyle:Ridge;" />
                                <asp:Label ID="lblIdOrden" runat="server" Text='<%# Eval("IdOrden") %>' />
                            </td>
                            <td>
                                <asp:Label ID="DescripcionLabel" runat="server" Text='<%# Eval("Descripcion") %>' />
