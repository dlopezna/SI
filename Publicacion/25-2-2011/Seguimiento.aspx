...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function openfrmIncidencia(){
            ...
            window.open('frmIncidencia.aspx',"Incidencias",'Location=NO, Directories=NO, Width=550,Height=380,Top=200,Resizable=NO,Menubar=NO,Titlebar=NO, Left=150,Toolbar=NO,Status=NO');
...
<asp:UpdateProgress ID="updP" runat="server" AssociatedUpdatePanelID="upd_lvPlantas"
        DisplayAfter="0">
        <ProgressTemplate>
            <div id="upd_progress">
                <div style="margin-top: 25%;">
                    <img src="../Images/loading.gif" alt="cargando..." class="transparente" />
                </div>
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>
    ...
    <div id="centro">
   <asp:UpdatePanel ID="upd_lvPlantas" runat="server">
            <ContentTemplate>
                        ...
                        <tr class="seleccion">
                            <td colspan="5" style="vertical-align: middle;">
                                ...
                                <img id="cmdOpenIncidencia" alt="Crear Incidencia" src="Images/atencion.gif" style="border: 1px;
                                    border-style: ridge; cursor: hand;vertical-align: middle" onclick="openfrmIncidencia()" />
